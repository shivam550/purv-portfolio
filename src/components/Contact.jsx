    ...
    <h2 className='text-4xl mb-8 text-emerald-400 font-semibold underline underline-offset-8'>Contact Me</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-xl transition-shadow duration-300 ">
          <h3 className="text-xl font-semibold text-black mb-2">Email Me</h3>
        ...
        {/* Phone Section */}
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-xl transition-shadow duration-300 ">
          <h3 className="text-xl font-semibold text-black mb-2">Call Me</h3>
          <p className="text-gray-600">
            <a
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-xl transition-shadow duration-300 ">
          <h3 className="text-xl font-semibold text-black mb-2">Follow Me</h3>
